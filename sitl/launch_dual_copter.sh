...
#   hunter_copter  - SYSID 51 - instance 0 - TCP 5760
#   target_copter  - SYSID 52 - instance 1 - TCP 5770
...
echo "[launch] Starting hunter_copter (SYSID 51, instance 0)..."
"$SCRIPT_DIR/launch_hunter_copter.sh" &
PID_HUNTER=$!

echo "[launch] Starting target_copter (SYSID 52, instance 1)..."
